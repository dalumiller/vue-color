  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      function r(e, t) {
        ...
        var a = n.toHsl(),
          o = n.toHsv();
        return (
          0 === a.s && (o.h = a.h = e.h || (e.hsl && e.hsl.h) || t || 0),
          {
            hsl: a,
        ...
        methods: {
          colorChange: function(e, t) {
            (this.oldHue = this.colors.hsl.h),
              (this.colors = r(e, t || this.oldHue));
          },
          isValidHex: function(e) {
            return (0, i.default)(e).isValid();
          },
          ...
          isTransparent: function(e) {
            return 0 === (0, i.default)(e).getAlpha();
          }
        }
      };
    },
          ...
          methods: {
            ...
            handleKeyDown: function(e) {
              ...
              if (n) {
                ...
                38 === e.keyCode &&
                  ((t = n + r), this.handleChange(t), e.preventDefault()),
                  40 === e.keyCode &&
                    ((t = n - r), this.handleChange(t), e.preventDefault());
              }
            }
    ...
    function(e, t, n) {
      ...
      t.default = {
        name: "Material",
        mixins: [s.default],
        components: { "ed-in": i.default },
        methods: {
          onChange: function(e) {
            e &&
              (e.hex
                ? this.isValidHex(e.hex) &&
                  this.colorChange({ hex: e.hex, source: "hex" })
                : (e.r || e.g || e.b) &&
                  this.colorChange({
    ...
    function(e, t, n) {
      ...
      t.default = {
        ...
        components: { hue: s.default },
        computed: {
          activeOffset: function() {
            var e = this.swatches.includes("0"),
              t = this.swatches.includes("1"),
              n = this.colors.hsl;
            return Math.round(100 * n.s) / 100 == 0.5
              ? Math.round(100 * n.l) / 100
              : e && 0 === n.l
              ? 0
              : t && 1 === n.l
              ? 1
          ...
          methods: {
            handleChange: function(e, t) {
              ...
              var n,
                ...
                c = a.getBoundingClientRect().top + window.pageYOffset,
        ...
        u = (function() {
          ...
          return (
            c.forEach(function(t) {
              var n = [];
              "black" === t.toLowerCase() || "white" === t.toLowerCase()
        ...
        methods: {
          ...
          handleChange: function(e, t) {
            ...
            var n = this.$refs.container,
              ...
              u = (0, i.default)(c - o, 0, r),
              d = (0, i.default)(l - s, 0, a),
              h = u / r,
              f = (0, i.default)(-d / a + 1, 0, 1);
    ...
    function(e, t, n) {
      ...
      t.default = {
        ...
        components: { checkboard: a.default },
        computed: {
          colors: function() {
            return this.value;
          },
        ...
        methods: {
          handleChange: function(e, t) {
            ...
            var n,
              ...
              a = r.clientWidth,
              i = r.getBoundingClientRect().left + window.pageXOffset,
      ...
      t.default = {
        ...
        computed: {
          bgStyle: function() {
            return {
              "background-image":
                "url(" + a(this.white, this.grey, this.size) + ")"
            };
          }
        }
      };
      ...
      t.default = {
        ...
        computed: {
          hex: function() {
            var e = void 0;
            return (
              (e = this.colors.a < 1 ? this.colors.hex : this.colors.hex),
              e.replace("#", "")
            );
          },
    ...
    function(e, t, n) {
      ...
      t.default = {
        ...
        data: function() {
          return { fieldsIndex: 1, highlight: !1 };
        },
        computed: {
          hsl: function() {
    ...
    function(e, t, n) {
      ...
      var a = n(23),
        ...
        j = {
          ...
          Chrome: m.default,
          Alpha: w.default,
          Checkboard: y.default,
          EditableInput: F.default,
          Hue: S.default,
          Saturation: E.default,
          ColorMixin: R.default
        };
      e.exports = j;
    },
    function(e, t, n) {
      ...
      e.exports = function(e, t) {
        for (var n = [], r = {}, a = 0; a < t.length; a++) {
          var i = t[a],
            ...
            c = i[2],
            l = i[3],
            u = { id: e + ":" + a, css: s, media: c, sourceMap: l };
    ...
    function(e, t, n) {
      ...
      !(function(a) {
        function i(e, t) {
          if (((e = e || ""), (t = t || {}), e instanceof i)) return e;
        ...
        function s(e, t, n) {
          return { r: 255 * E(e, 255), g: 255 * E(t, 255), b: 255 * E(n, 255) };
        }
        function c(e, t, n) {
        ...
        function v(e, t) {
          t = 0 === t ? 0 : t || 10;
          var n = i(e).toHsl();
          return (n.s -= t / 100), (n.s = L(n.s)), i(n);
        }
        function g(e, t) {
          t = 0 === t ? 0 : t || 10;
          var n = i(e).toHsl();
        ...
        function x(e, t) {
          t = 0 === t ? 0 : t || 10;
          var n = i(e).toHsl();
          return (n.l += t / 100), (n.l = L(n.l)), i(n);
        }
        function m(e, t) {
          t = 0 === t ? 0 : t || 10;
          var n = i(e).toRgb();
          return (
            (n.r = X(0, V(255, n.r - q((-t / 100) * 255)))),
            (n.g = X(0, V(255, n.g - q((-t / 100) * 255)))),
            (n.b = X(0, V(255, n.b - q((-t / 100) * 255)))),
            i(n)
          );
        }
        function _(e, t) {
        ...
        function y(e) {
          ...
          return [
            i(e),
            i({ h: (n + 120) % 360, s: t.s, l: t.l }),
            i({ h: (n + 240) % 360, s: t.s, l: t.l })
          ];
        }
        function k(e) {
          var t = i(e).toHsl(),
          ...
          return [
            i(e),
            i({ h: (n + 90) % 360, s: t.s, l: t.l }),
            i({ h: (n + 180) % 360, s: t.s, l: t.l }),
            i({ h: (n + 270) % 360, s: t.s, l: t.l })
          ];
        }
        function F(e) {
          var t = i(e).toHsl(),
          ...
          return [
            i(e),
            i({ h: (n + 72) % 360, s: t.s, l: t.l }),
            i({ h: (n + 216) % 360, s: t.s, l: t.l })
          ];
        }
        function A(e, t, n) {
          (t = t || 6), (n = n || 30);
        ...
        function S(e, t) {
          t = t || 6;
          for (
            var n = i(e).toHsv(), r = n.h, a = n.s, o = n.v, s = [], c = 1 / t;
            t--;

          )
            s.push(i({ h: r, s: a, v: o })), (o = (o + c) % 1);
          return s;
        }
        function M(e) {
          return (
        ...
        (i.prototype = {
          ...
          getLuminance: function() {
            ...
            return (
              ...
              (i = t <= 0.03928 ? t / 12.92 : a.pow((t + 0.055) / 1.055, 2.4)),
              (o = n <= 0.03928 ? n / 12.92 : a.pow((n + 0.055) / 1.055, 2.4)),
              0.2126 * r + 0.7152 * i + 0.0722 * o
            );
          },
          setAlpha: function(e) {
            return (
              (this._a = M(e)), (this._roundA = q(100 * this._a) / 100), this
            );
          },
          toHsv: function() {
          ...
          toName: function() {
            return 0 === this._a
              ? "transparent"
              : !(this._a < 1) && (Y[h(this._r, this._g, this._b, !0)] || !1);
          },
          toFilter: function(e) {
          ...
          (i.random = function() {
            return i.fromRatio({ r: G(), g: G(), b: G() });
          }),
          ...
          (i.isReadable = function(e, t, n) {
            var r,
              a,
              o = i.readability(e, t);
            switch (((a = !1), (r = N(n)), r.level + r.size)) {
              case "AAsmall":
              case "AAAlarge":
                a = o >= 4.5;
                break;
          ...
          (i.mostReadable = function(e, t, n) {
            ...
            for (var u = 0; u < t.length; u++)
              (r = i.readability(e, t[u])) > l && ((l = r), (c = i(t[u])));
            return i.isReadable(e, c, { level: o, size: s }) || !a
              ? c
    ...
    function(e, t, n) {
      ...
      var r = function() {
          ...
          return n("div", { staticClass: "vc-editable-input" }, [
            ...
            e._v(" "),
            n("span", { staticClass: "vc-input__desc" }, [e._v(e._s(e.desc))])
          ]);
        },
        a = [];
      r._withStripped = !0;
      var i = { render: r, staticRenderFns: a };
      t.a = i;
    },
    function(e, t, n) {
      "use strict";
          ...
          return n(
            ...
            [
              n("ed-in", {
                ...
                style: { borderColor: e.colors.hex },
                attrs: { label: "hex" },
    ...
    function(e, t, n) {
      ...
      var s = n(46),
        ...
        u = r,
        d = l(i.a, s.a, !1, u, null, null);
      (d.options.__file = "src/components/Slider.vue"), (t.default = d.exports);
    },
    function(e, t, n) {
      var r = n(42);
      "string" == typeof r && (r = [[e.i, r, ""]]),
    ...
    function(e, t, n) {
      ...
      var r = function() {
          var e = this,
            t = e.$createElement,
            n = e._self._c || t;
          return n("div", { class: ["vc-hue", e.directionClass] }, [
            n(
              "div",
              {
                ref: "container",
                    ...
                    [
                      n("div", {
                        ...
                        class: {
                          "vc-slider-swatch-picker--active":
                            t == e.activeOffset,
                          "vc-slider-swatch-picker--white": "1" === t
                        },
                        style: {
                          background:
                            "hsl(" + e.colors.hsl.h + ", 50%, " + 100 * t + "%)"
                        }
                      })
                    ]
                  );
    ...
    function(e, t, n) {
      ...
      var r = {
        ...
        k = { active: "rgba(0, 0, 0, 0.54)", inactive: "rgba(0, 0, 0, 0.38)" },
        F = {
            ...
            [
              n(
                ...
                e._l(e.palette, function(t, r) {
                  return n(
                    "div",
                    { key: r, staticClass: "vc-swatches-color-group" },
                    e._l(t, function(t) {
                      return n(
                        "div",
                        {
    ...
    function(e, t, n) {
      (function(t) {
        function n(e, t, n) {
          ...
          function d(e) {
            return (m = void 0), S && v ? r(e) : ((v = g = void 0), x);
          }
          function h() {
            void 0 !== m && clearTimeout(m), (k = 0), (v = _ = g = m = void 0);
          }
          function f() {
            return void 0 === m ? x : d(y());
          }
          function p() {
            var e = y(),
              n = l(e);
            if (((v = arguments), (g = this), (_ = e), n)) {
              if (void 0 === m) return i(_);
              if (A) return (m = setTimeout(u, t)), r(_);
            }
        ...
        function o(e) {
          return "symbol" == typeof e || (i(e) && _.call(e) == u);
        }
        function s(e) {
          ...
          e = e.replace(d, "");
          var n = f.test(e);
          return n || p.test(e) ? v(e.slice(2), n ? 2 : 8) : h.test(e) ? l : +e;
        }
                    ...
                    n(
                      ...
                      [
                        n("div", { staticClass: "vc-ps-hue-pointer" }, [
                          n("i", { staticClass: "vc-ps-hue-pointer--left" }),
                          n("i", { staticClass: "vc-ps-hue-pointer--right" })
                        ])
                      ]
                    )
                  ],
                ...
                n(
                  ...
                  [
                    n("div", { staticClass: "vc-ps-previews" }, [
                      ...
                      e._v(" "),
                      n("div", { staticClass: "vc-ps-previews__swatches" }, [
                        n("div", {
                          staticClass: "vc-ps-previews__pr-color",
                          style: { background: e.colors.hex },
                          attrs: {
    ...
    function(e, t, n) {
      ...
      var s = n(71),
        ...
        u = r,
        d = l(i.a, s.a, !1, u, null, null);
      (d.options.__file = "src/components/Sketch.vue"), (t.default = d.exports);
    },
    function(e, t, n) {
      var r = n(70);
      "string" == typeof r && (r = [[e.i, r, ""]]),
    ...
    function(e, t, n) {
      ...
      var s = n(75),
        ...
        u = r,
        d = l(i.a, s.a, !1, u, null, null);
      (d.options.__file = "src/components/Chrome.vue"), (t.default = d.exports);
    },
    function(e, t, n) {
      var r = n(74);
      "string" == typeof r && (r = [[e.i, r, ""]]),
                  ...
                  : n("div", { staticClass: "vc-chrome-fields-wrap" }, [
                      ...
                      n(
                        "div",
                        {
                          ...
                          on: { click: e.toggleViews }
                        },
                        [
                          n("div", { staticClass: "vc-chrome-toggle-icon" }, [
                            n(
                              "svg",
                              {
